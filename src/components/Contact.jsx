     ...
     p-4 text-white ">
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full ">
        <div className="pb-8">
          ...
          <p  className='py-6 text-2xl text-center font-medium'>Submit the form below to get in touch with me</p>
        </div>
        <div className='flex justify-center'>
          <form action=" https://getform.io/f/lajkdokb" method="POST" className="flex flex-col w-full md:w-1/2">
            ...
            bg-transparent
             ...
             <button className="text-white mt-4 bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 mx-auto
